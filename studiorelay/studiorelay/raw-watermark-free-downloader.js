(function () {
  ...
  function updateMiniBadge(progress = {}) {
    ...
    badge.innerHTML = `
      ...
      <span>⚡ <b>DragonBMT ZIP</b> ${progress.isPaused ? 'Paused' : 'Downloading'}: <b>${percent}%</b></span>
    `;
  }
  ...
  function ensureZipOverlay() {
    ...
    appendElement(badgeRow, 'div', {
      html: '<span style="color:#e8b44a;margin-right:4px;">⚡</span> Bulk Downloader by <b>DragonBMT</b>',
      style: [
        'display:inline-flex',
        'align-items:center',
        'padding:4px 12px',
    ...
    appendElement(footer, 'span', {
      text: '⚡ Bulk Downloader by DragonBMT',
